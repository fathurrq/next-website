...
const slides = [
  {
    ...
    text: (
      <>
        Integrity <span className="text-white/30">is our</span> <br />
        compass, quality <span className="text-white/30">is our</span> anchor
      </>
    ),
  },
  {
...
export default function CultureCarousel() {
  ...
  return (
    <div className="relative bg-[#0A436A] text-white p-6 md:p-10 rounded-lg shadow-lg h-[50vh] md:h-[60vh] overflow-hidden">
      {/* Slide animation */}
      <AnimatePresence mode="wait">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-[64px] font-bold"
        >
          {slides[index].text}
        </motion.h2>
      </AnimatePresence>
      ...
      <div className="bg-white/30 absolute bottom-[20px] left-[16px] right-[16px] flex justify-between items-center py-2 px-4 rounded">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <p className="text-sm md:text-lg lg:text-xl font-semibold">Our Culture</p>
