    ...
    <div id="articles" ref={articleRef} className="pb-12 w-full min-h-screen overflow-hidden bg-white">
      ...
      <div className="relative mt-[-20rem] md:mt-[-25rem] lg:mt-[-45rem] inset-0 w-full">
        <div className="container mx-auto px-4 lg:px-0 flex flex-col gap-2">
          {/* Breadcrumb */}
          <h3 className="text-white text-[5vw] md:text-[2.5vw] font-medium mb-2">Article / <span className="text-white/50 truncate">Pegawai PT Ke...</span></h3>
          {/* Title */}
          ...
          <div className="flex flex-col md:flex-row gap-8 p-4">
            ...
            <div className="w-full md:w-[600px] lg:w-[700px]">
              <p dangerouslySetInnerHTML={{ __html: article }} className="text-[4vw] md:text-[1.5vw] lg:text-[1.4vw] font-medium text-slate-800" />
            </div>
            {/* Keep Updated */}
