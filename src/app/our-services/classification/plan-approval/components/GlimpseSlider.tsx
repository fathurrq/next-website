...
export default function GlimpseSlider() {
  ...
  return (
    <section className="h-[85vh] relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[50vh] bg-[linear-gradient(to_bottom,transparent_0%,#0A436A50_50%,#0A436A_90%)] z-0" />
        ...
        <div className="flex flex-col justify-center items-center 2xl:gap-20 md:gap-16 gap-12 z-1">
          <AnimatePresence mode="wait">
            <motion.p
              ...
              className="text-white text-base sm:text-lg md:text-xl xl:text-3xl leading-relaxed md:leading-8 opacity-90 text-center"
