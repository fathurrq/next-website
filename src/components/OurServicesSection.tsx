...
export default function OurServicesSection() {
  ...
  return (
    <div
      id={"our-services"}
      ref={servicesRef}
      className="relative w-full h-[150vh] text-white bg-black"
    >
      {/* <div
      ...
      >
        <div className="absolute -top-10 left-0 right-0 w-full h-20 bg-[linear-gradient(to_bottom,transparent,rgba(11,63,101,1)_50%,transparent)] z-1" />
        ...
        <div className="flex flex-wrap justify-center gap-x-[30px] gap-y-[60px] mx-[50px] 2xl:mx-[70px] pb-[100px] 2xl:pb-0">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Bottom line */}
              <div className="absolute bottom-0 left-[32px] right-[32px] h-[2px] bg-white opacity-30 z-10" />
              <div
