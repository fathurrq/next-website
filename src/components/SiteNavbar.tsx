...
const NAV = [
    {label: "Home", href: "/"},
    {
        ...
        href: "#",
        submenu: [
            {label: "Classification", href: "/our-services#classification", type: ''},
            {label: "Statutory", href: "/our-services#statutory", type: ''},
            {label: "Marine Services", href: "/our-services#marine-services", type: ''},
            {label: "Energy & Industry", href: "/our-services#energy-industry", type: ''},
    ...
    },
    {
        ...
        href: "#",
        submenu: [
            {label: "Research & Development", href: "https://www.bki.co.id/rnd.html", type: ''},
            {label: "Technical Journal", href: "https://www.bki.co.id/halamanstatis-119.html", type: ''},
        ],
    },
    {
        label: "Publication",
        ...
        submenu: [
            ...
            {label: "Annual Report", href: "https://www.bki.co.id/download-2-1.html", type: ''},
        ],
    },
    {
        label: "About Us",
        href: "#",
        submenu: [
            {label: "Company Profile", href: "/company-profile", type: ''},
            {label: "Achievement", href: "/achievements", type: ''},
            {label: "Opportunity", href: "https://www.bki.co.id/halamanstatis-133.html", type: ''},
            {label: "Documentation", href: "https://www.bki.co.id/galery.html", type: ''},
