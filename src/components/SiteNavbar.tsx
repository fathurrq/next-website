...
const NAV:Navigation[] = [
  { label: "Home", href: "/" },
  {
    ...
    submenu: [
      ...
      { label: "BKI Academy", href: "/our-services#bki-academy", type: "" },
    ],
  },
  {
    label: "Research",
  ...
  },
  {
    ...
    href: "#",
    submenu: [
      { label: "News", href: "/news", type: "" },
      { label: "Events", href: "/events", type: "" },
    ...
    submenu: [
      {
        ...
        submenu: [
          {
            label: "Introduction",
            href: "/company-profile#introduction",
            type: "",
          },
          {
            label: "Vision, Mission, Culture",
            href: "/company-profile#vision-mission-culture",
            type: "",
          },
          { label: "Our History", href: "/company-profile#history", type: "" },
          { label: "BOC", href: "/company-profile#boc", type: "" },
          { label: "BOD", href: "/company-profile#bod", type: "" },
          {
            label: "Technical Committee",
            href: "/company-profile#technical-committee",
            type: "",
          },
          {
            label: "Organization Structure",
            href: "/company-profile#organization-structure",
            type: "",
          },
        ],
      },
...
export default function SiteNavbar() {
  ...
  const handleSubEnter = (si: number) => {
    setSubHovered(si);
  };
                          ...
                          {hovered === i && (
                            <motion.div
                              ...
                              animate={{
                                ...
                                y: 0,
                                scale: 1,
                                width: subHovered !== null ? 480 : 240,
                                minWidth: subHovered !== null ? 480 : 240,
                              }}
                              exit={{
                                opacity: 0,
                                y: 8,
                            ...
                            >
                              <div
                                className="flex rounded-2xl shadow-2xl overflow-visible border border-white/10 backdrop-blur-md p-4 py-0 bg-gradient-to-r from-[rgba(10,67,106,0.70)] to-[rgba(0,0,0,0.70)]"
                                style={{
                                  borderRadius: "10px",
                              ...
                              >
                                ...
                                {/* Right side sub-submenu as flex child (not absolute) */}
                                {subHovered !== null && (
                                  <motion.div
                                    layout
                                    initial={{ opacity: 0 }}
