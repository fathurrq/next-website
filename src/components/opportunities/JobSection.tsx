...
export default function JobSection() {
    ...
    return (
        <div
            ...
            className="font-montserrat text-black flex flex-col w-full h-auto p-16 2xl:p-24 gap-12 2xl:gap-16 bg-gradient-to-b from-[#FFFFFF] to-[#BF9F5F]"
        >
            <div className="w-full h-auto flex flex-col justify-center items-center gap-12 px-4 2xl:px-6 py-12 2xl:py-16 bg-white shadow-md">
                <div className="flex flex-col items-center text-center gap-3 2xl:gap-5">
                    <h3 className="font-bold text-[#BF9F5F] text-3xl 2xl:text-5xl">Job Opportunities</h3>
                    <p className="">BKI believe putting the best people in accordance with the interests and abilities are key in regulating human resources.
                ...
                <div className="w-full h-auto flex flex-col bg-white border border-gray-300">
                    <h3 className="font-bold text-[#0A436A] text-3xl 2xl:text-5xl 2xl:py-6 2xl:px-4 py-4 px-2">Head Office - Jakarta</h3>
                        ...
                        <AccordionItem key={index} title={item.title}>
                            <div>
                                ...
                                <div className="flex justify-end">
                                    <Link href="/apply" className="px-4 py-2 bg-[#0A436A] text-white rounded-lg shadow hover:bg-[#08324f] transition">
                                        Apply
                                    </Link>
                                </div>
                            </div>
